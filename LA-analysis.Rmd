...
```{r}
temp<-aggregate(dat$Avg..DFW.RATE,by=list(dat$Term),mean)
temp$Group.1=factor(temp$Group.1,levels = c("Fall 2016","Spring 2017","Fall 2017","Spring 2018","Fall 2018"))
temp2<-temp[c(1,4,2,5,3),]
plot(y=c(.15,.3),x=c(1,5),type="n")
